    ...
    <main>
        ...
        <div>
            <div className='bg-black'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner2} className='w-full h-full lg:h-170 object-cover' alt='Niagara Falls Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-[#0a0a0a]'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner3} className='w-full h-full lg:h-170 object-cover' alt='1000 Islands Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-black'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner4} className='w-full h-full lg:h-170 object-cover' alt='Toronto City Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-[#0a0a0a]'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner5} className='w-full h-full lg:h-170 object-cover' alt='Ottawa Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-black'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner6} className='w-full h-full lg:h-170 object-cover' alt='Montreal Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-[#0a0a0a]'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner7} className='w-full h-full lg:h-170 object-cover' alt='Sault Ste. Marie Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
        ...
        <div>
            <div className='bg-black'>
                <div className='grid grid-cols-1 lg:grid-cols-2' data-aos="fade-up">
                    <div>
                        <Image src={AreasBanner8} className='w-full h-full lg:h-170 object-cover' alt='Blue Mountains Tours by Limo Royale' />
                    </div>
                    <div className='p-5 md:p-15 flex flex-col justify-center'>
