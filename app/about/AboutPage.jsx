  ...
  return (
    <main>
      ...
      <div>
          ...
          <div className='relative z-10 pt-40 lg:pt-80 pb-0 md:pb-30'>
      ...
      <div>
        <div className='container mx-auto px-2' data-aos="fade-up">
          <div className='pt-20 lg:pt-5 pb-5'>
            <h1 className='text-white text-2xl lg:text-4xl mb-5 lg:mb-0 pr-0 leading-snug font-medium'>Experience True Luxury with Over 20 Years of Global Expertise</h1>
          </div>
          <div>
          ...
          <div data-aos="fade-up">
            <h2 className='text-white text-2xl lg:text-4xl leading-snug mt-5 mb-5'>Our Legacy of Excellence</h2>
            ...
            <div className='pb-10 mb-10 border-b webBorderColor'>
              ...
              <div className='lg:space-x-10 space-y-10 lg:space-y-0'>
                ...
                >
                  <SwiperSlide>
                    <div className='bg-[#0a0a0a] p-7 min-h-[345px]'>
      ...
      <div>
        <div className='container mx-auto px-2'>
          <div className='grid md:grid-cols-2 space-x-4 pt-8' data-aos="fade-up">
            <div>
      ...
      <div>
        <div className='relative pt-5 lg:pt-5 pb-8'>
          <div className='container mx-auto px-2'>
            ...
            <div className='lg:space-x-5 space-y-5 lg:space-y-0 mt-10'>
              <Swiper
                modules={[Autoplay]}
                spaceBetween={40}
                slidesPerView={1}
      ...
      <div>
        <div className='bg-[#0a0a0a] py-8 pr-5 xl:pr-62 pl-5 lg:pl-0'>
      ...
      <div>
        <div className='relative pt-0 lg:pt-0 pb-8'>
          <div className='container mx-auto px-2'>
            <h2 className='text-white text-2xl lg:text-3xl leading-snug mb-5 font-medium'>Why Choose a Royale Chauffeur?</h2>
            ...
            <div className='md:space-x-4 space-y-5 lg:space-y-0 mt-10'>
              <Swiper
                modules={[Autoplay]}
                spaceBetween={15}
                slidesPerView={1}
      ...
      <div>
        <div className='bg-[#0a0a0a] py-8 pr-5 xl:pr-62 pl-5 lg:pl-0'>
          <div className='flex flex-col lg:flex-row lg:space-x-12 space-y-10 lg:space-y-0'>
            <div className='w-full lg:w-3/5' data-aos="fade-up">
                <Image src={AboutBanner3} className='w-full h-full md:h-[650px] object-cover object-bottom' alt='Royal Experience in Limo Royale' />
            </div>
            <div className='w-full lg:w-2/5' data-aos="fade-up">
              <small className='webColor uppercase'>Goal</small>
      ...
      <div className='pb-8'>
        <div className='container mx-auto px-2'>
          <div className='lg:space-x-4 space-y-5 lg:space-y-0'>
            ...
            >
              <SwiperSlide>
                <div className='bg-[#0a0a0a] p-5 lg:p-10 min-h-[685px]' data-aos="fade-up">
