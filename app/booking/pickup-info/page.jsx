              ...
              <div className="bg-white rounded-md shadow-xl overflow-hidden text-black mb-5 md:mb-0">
                <div className="p-4 md:p-8">
                  ...
                  <div className="mt-4 grid gap-4">
                    {pricedVehicles.slice(3, 4).map((v, idx) => {
                      return (
                        <div role="button"
                          key={v.id}
                          onClick={() => {
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <div className="block md:flex items-start justify-between">
                              <div>
                                <div className="font-semibold text-sm md:text-xl mt-2 mb-2">{v.name}</div>
                                <div className="text-xs text-gray-600 my-1 hidden md:block" dangerouslySetInnerHTML={{ __html: v.desc }} />
                              </div>
