...
const FloatingActions = () => {
  return (
    <div className="fixed bottom-25 md:bottom-15 right-5 flex-col items-end space-y-3 z-50 flex">
      ...
      {/* WhatsApp */}
      <a href="https://wa.me/+14167255466" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-white">
      ...
      {/* Phone */}
      <a href="tel:+14167255466" className="flex items-center space-x-2 text-white">
